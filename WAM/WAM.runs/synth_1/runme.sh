...
HD_PWD='C:/Users/alexn/OneDrive/Documents/Projects/whackam01e/WAM/WAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log wamTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source wamTop.tcl
