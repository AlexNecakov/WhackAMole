...
HD_PWD='C:/Users/alexn/OneDrive/Documents/Projects/whackam01e/WAM/WAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log wamTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source wamTop.tcl -notrace
